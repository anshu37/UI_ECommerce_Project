...
//
//        File reportOutputDirectory = new File("reports/cucumber-html-report");
//        File jsonFile = new File("target/cucumber-report/cucumber.json");
//
//        Configuration configuration = new Configuration(reportOutputDirectory, "UI_Ecom_Project");
//
...
//                new ReportBuilder(
//                        Collections.singletonList(jsonFile.getAbsolutePath()),
//                        configuration
//                );
//
